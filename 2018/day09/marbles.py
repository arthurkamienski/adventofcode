...
class Game:
    ...
    def insert_marble(self):
        ...
        left_marble = self.curr_marble.right
        right_marble = left_marble.right

        new_marble = Marble(self.next_marble, left_marble, right_marble)
        
        # list insert
        left_marble.right = new_marble
        right_marble.left = new_marble 
    ...
    def remove_marble(self):
        ...
        for i in range(7):
            removed_marble = removed_marble.left

        # left and right to the removed marble
        left = removed_marble.left
        right = removed_marble.right
